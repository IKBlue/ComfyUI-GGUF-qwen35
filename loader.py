...
# Modified 2026 by IKBlue to add Qwen3.5 ("qwen35") text-encoder support:
#   * "qwen35" added to TXT_ARCH_LIST
#   * a qwen35 branch in gguf_clip_loader() delegating to qwen35_support.py
import warnings
import logging
import torch
import gguf
...
TXT_ARCH_LIST = {"t5", "t5encoder", "llama", "qwen2vl", "qwen3", "qwen3vl", "gemma3", "qwen35"}
